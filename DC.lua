...
-----------------------------------------------------------------
local Window = OrionLib:MakeWindow({Name = "“楠羽”", HidePremium = false, SaveConfig = true,IntroText = "“楠羽”", ConfigFolder = "“楠羽”"})
-----------------------------------------------------------------------------------------------------
...
about:AddParagraph("该脚本为0.1版，永久免费")
about:AddParagraph("脚本免费脚本")
about:AddParagraph("楠羽NB")
about:AddParagraph("别倒卖 ")
-----------------------------------------------------------------------------------------------------
